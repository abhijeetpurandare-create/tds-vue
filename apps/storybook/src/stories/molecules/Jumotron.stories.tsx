...
const Jumbotron = lazy(() => import('component-library/AnimatedJumbotron')
  .catch(err => {
    console.error('Error loading Jumbotron component:', err);
    return { default: () => <div className="error-fallback">Failed to load Jumbotron component</div> };
  })
);
...
const JumbotronWrapper = (props: any) => (
  <Suspense fallback={<div>Loading jumbotron component...</div>}>
    <Jumbotron {...props} />
  </Suspense>
);
