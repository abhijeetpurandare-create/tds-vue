...
import { Meta, StoryFn } from '@storybook/react-vite'; // Import Storybook types
import BusinessPill from '../../../../../packages/molecules/src/businessPill';



const meta: Meta<typeof BusinessPill> = {
  title: 'Test/BusinessPill',
  component: BusinessPill,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
