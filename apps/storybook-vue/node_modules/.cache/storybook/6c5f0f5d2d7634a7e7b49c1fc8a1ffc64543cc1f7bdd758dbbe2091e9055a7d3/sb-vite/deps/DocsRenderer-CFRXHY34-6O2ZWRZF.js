...
import {
  ...
  yI,
  zr
} from "./chunk-BR2P737G.js";
import {
  require_react
} from "./chunk-Y7O4GGEI.js";
import {
  dedent
...
// ../../node_modules/.pnpm/@storybook+addon-docs@8.4.7_@types+react@18.2.0_storybook@8.4.7/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@8.4.7_react-dom@18.2.0_react@18.2.0_storybook@8.4.7/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-JNOYFTM5.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-F6OSRLHC-VE6NILFE.js"));
...
// ../../node_modules/.pnpm/@storybook+react-dom-shim@8.4.7_react-dom@18.2.0_react@18.2.0_storybook@8.4.7/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-5QYMVF6J.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-6O2ZWRZF.js.map
